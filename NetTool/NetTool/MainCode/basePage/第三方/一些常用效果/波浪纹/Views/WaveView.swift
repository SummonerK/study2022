...
class WaveView: UIView {
    ...
    // 波浪宽度系数a
    var waveRate: CGFloat = 0.012
    // 波浪移动速度
    var waveSpeed: CGFloat = 0.02
    // 真实波浪颜色
    var realWaveColor: UIColor = UIColor.hexStringColor(hexString: "4F9BFA")
    // 阴影波浪颜色
    var maskWaveColor: UIColor = UIColor.hexStringColor(hexString: "4F9BFA",alpha: 0.3)
    // 波浪位置（默认是在下方）
